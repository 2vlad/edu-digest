...
ПРАВИЛА ЛАКОНИЧНОЙ СУММАРИЗАЦИИ:
1. Максимум 100-120 символов (одно предложение)  
2. Формат: "Компания/кто + действие/что сделала + краткий результат"
3. Убирай вводные слова, сокращай до сути
4. Включай конкретику: суммы, цифры, технологии
5. Пиши на русском языке

ПРИМЕРЫ ОТЛИЧНЫХ САММАРИ:
"Coursera запустила ИИ-ассистента для создания курсов"
"Сбер добавил VR-технологии в образовательную платформу" 
"MAXIMUM Education привлекла $15M для AI-платформы подготовки к ЕГЭ"

ИЗБЕГАЙ:
- Лишних слов и конструкций
- "Объявила о...", "Представила новый...", "Запустила проект..."
- Просто: "Компания сделала X\""""

        user_prompt = f"""Создай лаконичное саммари для этой EdTech новости:

{message_text}

Источник: {channel_name}

Максимум 120 символов, только суть."""
